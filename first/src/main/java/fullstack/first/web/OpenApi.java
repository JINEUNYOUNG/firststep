...
public class OpenApi {
    public static String[] fetchDataAndPrint(){
        String[] v = new String[5];
        String s = get(58, 126, v); // 신정동!
        ...
        try
        {
            ...
            URL url = new URL(
                    "http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtFcst"
                            + "?ServiceKey=N556W%2BJkyQFONpFgHokXLK6Dnrj4OV1mF1yF8h5%2F8pJUY%2F3c%2F4GMP3k4ZxsgmxcYrwoC6imFdps5xtpERyXQHg%3D%3D" // 서비스키
